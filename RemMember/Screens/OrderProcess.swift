    ...
    var body: some View {
        VStack {
            ...
            VStack(alignment: .leading, spacing: 10){
                ...
                HStack(spacing: 15){
                    Rectangle()
                        .fill(viewModel.book.status == "Заказ оформлен" || viewModel.book.status == "Мастер в пути" || viewModel.book.status == "Заказ подтвержден" || viewModel.book.status == "Мастер у вас" ? Color("blue") : Color.gray.opacity(0.5))
                        .frame(width: 80, height: 13)
                        .cornerRadius(5)
                    Rectangle()
                        .fill(viewModel.book.status == "Мастер в пути" || viewModel.book.status == "Мастер у вас" ? Color("blue") : Color.gray.opacity(0.5))
                        .frame(width: 80, height: 13)
                        .cornerRadius(5)
                    Rectangle()
                        .fill(viewModel.book.status == "Мастер в пути" || viewModel.book.status == "Мастер у вас" ? Color("blue") : Color.gray.opacity(0.5))
                        ...
                        .cornerRadius(5)
                    Rectangle()
                        .fill(viewModel.book.status == "Мастер у вас" ? Color("blue") : Color.gray.opacity(0.5))
                        .frame(width: 80, height: 13)
                        .cornerRadius(5)
                }.padding()
            }
